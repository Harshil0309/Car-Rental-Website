import { Col, Row, DatePicker, Checkbox, Modal, Card, Divider, Button, Tag, Space } from "antd";
      ...
      >
        ...
        <Col lg={10} sm={24} xs={24} className="p-3">
          ...
          >
            {car.name && (
              <>
                <h2 style={{ marginBottom: '1.5rem', fontSize: '1.8rem', fontWeight: '700' }}>
                  {car.name}
                </h2>
                ...
                {from && to && (
                  <Card style={{ background: '#f5f7fa', borderRadius: '8px', border: 'none', marginBottom: '1.5rem' }}>
                    <div style={{ marginBottom: '1rem' }}>
                      <p style={{ fontSize: '0.9rem', color: '#666' }}>
                        <CalendarOutlined /> <strong>Duration:</strong> {totalHours} hours
                      </p>
                      <p style={{ fontSize: '0.9rem', color: '#666' }}>
                        <DollarOutlined /> <strong>Base Rate:</strong> ${car.rentPerHour} × {totalHours} hours = ${car.rentPerHour * totalHours}
                      </p>
                    </div>
                    ...
                    {driver && (
                      <p style={{ fontSize: '0.9rem', color: '#667eea', fontWeight: '500', marginBottom: '1rem' }}>
        ...
        {car.name && (
          ...
          >
            {car.bookedTimeSlots && car.bookedTimeSlots.length > 0 ? (
              ...
              <p style={{ color: '#667eea', fontWeight: '500', textAlign: 'center', padding: '20px 0' }}>
