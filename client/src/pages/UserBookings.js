              ...
              {userBookings.map((booking, index) => (
                ...
                >
                  <Row gutter={0}>
                    ...
                    {/* Booking Details */}
                    <Col lg={12} md={16} sm={24} xs={24} style={{ padding: '1.5rem' }}>
                      <div style={{ marginBottom: '1rem' }}>
                        <h3 style={{ marginBottom: '0.5rem', fontSize: '1.3rem', fontWeight: '700' }}>
                          {booking.car.name}
                        </h3>
                        <Space wrap>
                          <Tag color="blue">💰 ${booking.car.rentPerHour}/hour</Tag>
                          <Tag color="green">⛽ {booking.car.fuelType || 'N/A'}</Tag>
                          <Tag color="orange">👥 {booking.car.capacity} seats</Tag>
                        </Space>
                      </div>
                      ...
                      <Space direction="vertical" size="small" style={{ width: '100%' }}>
                        ...
                        <p style={{ margin: '8px 0', fontSize: '0.95rem', color: '#666' }}>
                          <strong>Booking Date:</strong> {moment(booking.createdAt).format('MMM DD, YYYY')}
                        </p>
                      </Space>
                    </Col>

                    {/* Summary */}
                    <Col lg={6} md={24} sm={24} xs={24} style={{ 
                      padding: '1.5rem',
                      background: '#f5f7fa',
                      display: 'flex',
                      ...
                      <div>
                        <p style={{ fontSize: '0.85rem', color: '#666', marginBottom: '0.5rem' }}>Total Amount</p>
                        <h3 style={{ 
                          fontSize: '1.5rem', 
                          fontWeight: '700',
                      ...
                      <div style={{ marginTop: '1rem' }}>
                        <p style={{ fontSize: '0.8rem', color: '#999', marginBottom: '0.5rem' }}>Transaction ID</p>
                        <p style={{ 
                          fontSize: '0.75rem', 
                          color: '#667eea', 
                          fontWeight: '500',
